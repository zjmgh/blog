...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
        <h1 class="page-header">管理<span class="badge"><?php echo $total = getCount('content');?></span></h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            $rows = get('content',"cid limit {$arr['offSet']},{$pageSize}");
            if(is_array($rows)):
            foreach($rows as $v):
            ?>
            <tbody>
            <tr>
              ...
              <td class="hidden-sm"><?php echo showCount('talk',cid,$v['cid']);?></td>
              <td><?php echo date('Y-m-d',$v['c_date'])?></td>
              <td><a href="show-article.php?cid=<?php echo $v['cid'];?>" class="btn btn-default">阅读全文</a><a href="del-article.php?cid=<?php echo $v['cid'];?>" rel="6" class="btn btn-danger">&nbsp;删除</a></td>
            </tr>
            </tbody>
            <?php
            endforeach;
